...
if __name__ == '__main__':
    ...
    df_Posteriors["embs_0"]=(df_Posteriors["embs_0"]-np.mean(df_Posteriors["embs_0"]))/np.std(df_Posteriors["embs_0"])
    df_Posteriors["embs_1"]=(df_Posteriors["embs_1"]-np.mean(df_Posteriors["embs_1"]))/np.std(df_Posteriors["embs_1"])
    df_Posteriors["embs_2"]=(df_Posteriors["embs_2"]-np.mean(df_Posteriors["embs_2"]))/np.std(df_Posteriors["embs_2"])
    df_Posteriors["embs_3"]=(df_Posteriors["embs_3"]-np.mean(df_Posteriors["embs_3"]))/np.std(df_Posteriors["embs_3"])
    df_Posteriors["embs_4"]=(df_Posteriors["embs_4"]-np.mean(df_Posteriors["embs_4"]))/np.std(df_Posteriors["embs_4"])
    df_Posteriors["embs_5"]=(df_Posteriors["embs_5"]-np.mean(df_Posteriors["embs_5"]))/np.std(df_Posteriors["embs_5"])
    df_Posteriors["embs_6"]=(df_Posteriors["embs_6"]-np.mean(df_Posteriors["embs_6"]))/np.std(df_Posteriors["embs_6"])
